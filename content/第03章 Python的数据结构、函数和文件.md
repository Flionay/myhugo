...
date= 2019-01-13T20:59:58+08:00
draft = false
...
Summary = " 第3章 本章讨论Python的内置功能，它们是和Python的内置数据处理工具一同使用的。然后会从Python最基础的数据结构开始：元组、列表、字典和集合。然后会讨论创建你自己的、可重复使用的Python函数。最后，会学习Python的文件对象，以及如何与本地硬盘交互。 "
+++
